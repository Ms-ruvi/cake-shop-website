...
<section class="about">
    ...
    <div class="flex">
        ...
        <div class="content">
            <h3>Why Choose Us?</h3>
            <p>At R&R Bakes, we understand that every celebration deserves something special. That's why we strive to create cakes that not only look stunning but also taste divine. With our dedication to quality and craftsmanship, we ensure that every cake we bake becomes the centerpiece of your memorable moments.</p>
